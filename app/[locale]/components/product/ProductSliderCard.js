...
export function ProductSliderCard({ item, layout, index, inSimilar }) {
  ...
  return (
    <div className="h-[120px] min-w-[235px] bg-white rounded-md overflow-hidden border rtl:right-dir">
      <div className="flex">
        ...
        <div className="flex-1 px-2 py-1">
          ...
          <div className="flex gap-2 items-center mt-2">
            <button className="text-[10px] p-1 rounded-xl mx-auto w-[80%] block bg-primary text-white">
              {t("ADD_TO_CART")}
            </button>
