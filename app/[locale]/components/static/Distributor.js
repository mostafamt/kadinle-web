  ...
  return (
    <>
      ...
      <div className="flex flex-col poppins mb-10">
        ...
        />
        {openForm ? (
          <OurFranchiseForm locale={locale} applicationName="distributorApplicationName" />
        ) : (
          <>
            ...
            <div className="container mt-8 text-xs px-4">
              ...
              <p className="mb-1">
                {t("email_service")}:{" "}
                <Link href="mailto:service@kadinle.com">service@kadinle.com</Link>
              </p>
              <p className="mb-1">
                {t("WhatsApp")}:{" "}
                <Link href="whatsapp://send?abid=00905527869824">
                  0090 552 786 98 24‬‏{" "}
                </Link>
              </p>
            </div>
