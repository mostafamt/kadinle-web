...
export const Menu = async ({ locale }) => {
  ...
  return (
    <div className="xs:h-16 container flex flex-col xs:flex-row gap-4 items-center justify-between">
      <SearchBar />
      <Link
        href="/"
      ...
      <IconsBar locale={locale} languages={languages} countries={countries} />
    </div>
  );
};
