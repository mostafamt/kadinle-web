...
const HomeSliderSkeleton = () => {
  ...
  return (
    <div className=" flex flex-col items-center justify-center relative pb-[64px] order-[9]">
      ...
      <div className="w-[80%] lg:w-[60%] flex relative overflow-y-visible overflow-x-clip">
        <div className="w-full flex direction-ltr">
          {Array(3)
            ...
            .map((_, idx) => (
              <div
                key={idx}
                className={`h-[200px] sm:h-[250px] md:h-[300px] lg:h-[350px] xl:h-[500px] max-w-[400px] min-w-[33.333%] relative ${
                  idx === 1 && "z-50"
                } `}
              >
                <div
                  className={`w-full h-full bg-gray-200 animate-pulse ${
                    idx === 1 &&
                    "scale-[1.2] border rounded-[7px] border-opink "
                  }`}
                />
                {idx === 1 && (
