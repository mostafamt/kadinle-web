    ...
    <div className="flex gap-2 border shadow-sm mb-4 border-gray-200 items-start rounded-md p-4">
      <figure className="p-1 rounded-full border shadow shrink-0">
        {!defaultImage ? (
          ...
          <span className="w-14 h-14 object-cover flex items-center justify-center capitalize rounded-full bg-orange-400 text-white">
            {first_name?.[0]}
          </span>
        )}
      </figure>
      <div className="">
        ...
        <small className="text-[9px] text-gray-600 block -mt-1 mb-2">
