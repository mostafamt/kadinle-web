...
export const CartSendGift = ({ sendGiftMessage, setSendGiftMessage }) => {
  ...
  return (
    <>
      {open ? (
        <div className="mx-4 mt-4 flex flex-col gap-2 bg-gray-100 w-full p-1 rounded-xl overflow-hidden border border-gray-200 bg max-w-sm lg:max-w-[500px] mb-8 relative">
          <button
        ...
        <button
          ...
          className="mb-8 flex items-center text-opink text-sm px-4 mt-4"
        >
          {t("sendAsGift")}{" "}
