      ...
      {warehouseInformation ? (
        <div>
          {total >= FREE_SHIPPING_COST ? (
            <div
              className={`flex flex-col mb-4 flex-1 gap-2 items-center border border-gray-300 text-sm capitalize justify-center p-2 px-4 cursor-pointer rounded-md ${
                SHIPPING_TYPE[1] === shipping_type ? "bg-opink text-white" : ""
              }`}
              onClick={() => {
            ...
            >
              <div className="flex items-center gap-2 justify-center">
                <strong className="md:text-xl capitalize text-inherit font-medium">
                  {t("Free_Shipping")}
                </strong>
              </div>
