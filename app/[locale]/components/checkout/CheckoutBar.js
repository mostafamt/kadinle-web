...
import { CheckCompletedIcon } from "../Icons/CheckCompletedIcon";
...
export const CheckoutBar = ({ stage }) => {
  return (
    <div className="w-[270px] mx-auto mt-4 mb-6 ">
      <div className="flex justify-between mb-3 items-end">
        ...
        />
        <CardIcon
          className={`w-10 h-10 ltr:ml-1 rtl:mr-1 p-1 rounded-full ${
            stage > 3
              ? "!w-9 !h-9 border border-opink text-opink"
              : stage === 3
              ? "bg-opink text-white"
              : "text-secondary"
          }`}
