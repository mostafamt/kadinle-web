...
import Image from "next/image";
import { SupportBox } from "../../components/profile/SupportBox";
      ...
      <div className="flex flex-col poppins container w-full mb-12">
        ...
        <div className="flex flex-col gap-4 text-xs mt-4">
          ...
          <Link
            ...
            className=" flex-1 flex-col gap-1 whitespace-nowrap max-w-md w-full text-white bg-primary hover:text-primary hover:bg-transparent duration-200 border border-primary flex items-center justify-center py-1 px-4 rounded-[50px] mx-auto"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-6 gap-4">
          <Link
            ...
            className="relative before:w-1 before:h-full before:absolute ltr:before:left-0 rtl:before:right-0 bg-gray-100 before:bg-primary hover:before:w-full before:duration-200 text-sm hover:scale-105 duration-200 hover:!text-white text-primary whitespace-nowrap overflow-hidden flex items-center px-4 py-2 rounded-md hover:shadow"
          >
            <span className="relative z-10">
              {" "}
              {t("store_benefits.store_benefits_title")}{" "}
            </span>
          </Link>
          <Link
            href="/work-mechanism"
          ...
          >
            <span className="relative z-10">
              {" "}
              {t("work_mechanism.work_mechanism_title")}{" "}
            </span>
          </Link>
          <Link
          ...
          >
            <span className="relative z-10">
              {" "}
              {t("terms_and_conditions.terms_conditions")}{" "}
            </span>
          </Link>
          <Link
            href="/public-policy"
          ...
          >
            <span className="relative z-10">
              {" "}
              {t("public_policy_page.public_policy")}{" "}
            </span>
          </Link>
          <Link
          ...
          >
            <span className="relative z-10">
              {" "}
              {t("services_privileges.services_privileges_title")}{" "}
            </span>
          </Link>
          <Link
          ...
          >
            <span className="relative z-10">
              {" "}
              {t("kadinle_rights_duties.rights_duties")}{" "}
            </span>
          </Link>
        </div>
      </div>
