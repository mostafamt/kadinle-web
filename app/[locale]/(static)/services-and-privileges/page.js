...
export async function generateMetadata({ params: { locale } }) {
  const t = await getTranslator(locale, "services_privileges");
  return {
...
const page = async ({ params: { locale } }) => {
  ...
  return (
    <>
      <ScrollUpComponent />
      <MainTitle title={t("services_privileges_title")} />
      <div className="flex flex-col poppins  md:max-w-[575px] md:mx-auto w-full text-xs">
