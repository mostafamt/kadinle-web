...
export const addNewSupplierRegistration = async (data) =>
  await supabase.from("supplier_request").insert(data).select("id");

export const addNewSupplier = async (data) => {
  const res = await supabase.from("supplier").insert(data);
  return res;
};
...
export const addSupplierRequest = async (data) => {
  const res = await supabase.from("supplier_request").insert(data);
  return res;
};

export const addSupplierAttachment = async (data) => {
  const res = await supabase.from("supplier_attachment").insert(data);
  return res;
};
